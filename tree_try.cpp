...
std::vector<std::vector<double>> readFileToArray(const std::string& filename) {
...
int main() {
    ...
    std::vector<std::vector<double>> init_data = readFileToArray(IC16.txt);
